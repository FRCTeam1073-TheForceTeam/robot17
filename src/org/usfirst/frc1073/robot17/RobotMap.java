...
public class RobotMap {
    ...
    public static void init() {
    	...
    	/**Manually adding gyro**/
        headingGyro = new ADXRS450_Gyro();
        LiveWindow.addSensor("DriveTrain", "headingGyro", headingGyro);
        
        /**Manually adding gear sensor until actually added in RobotBuilder**/
        driveTrainGearSensor = new AnalogInput(1);
        LiveWindow.addSensor("DriveTrain", "ProximitySensorGear", driveTrainGearSensor);
