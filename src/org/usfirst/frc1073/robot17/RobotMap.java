...
public class RobotMap {
    ...
    public static AnalogGyro pIDDrivegyro;
    public static CANTalon pIDDriveleftMotor1;
    public static CANTalon pIDDriveleftMotor2;
    public static CANTalon pIDDriveleftMotor3;
    public static CANTalon pIDDriverightMotor1;
    public static CANTalon pIDDriverightMotor2;
    public static CANTalon pIDDriverightMotor3;
    public static AnalogInput pIDDriveprox1;
...
//        LiveWindow.addActuator("DriveTrain", "rightMotor3", driveTrainrightMotor3);
        ...
        pIDDrivegyro = new AnalogGyro(0);
        LiveWindow.addSensor("PIDDrive", "gyro", pIDDrivegyro);
        pIDDrivegyro.setSensitivity(0.007);
        pIDDriveleftMotor1 = new CANTalon(1);
        LiveWindow.addActuator("PIDDrive", "leftMotor1", pIDDriveleftMotor1);
        
        pIDDriveleftMotor2 = new CANTalon(2);
        LiveWindow.addActuator("PIDDrive", "leftMotor2", pIDDriveleftMotor2);
        
        pIDDriveleftMotor3 = new CANTalon(3);
        LiveWindow.addActuator("PIDDrive", "leftMotor3", pIDDriveleftMotor3);
        
        pIDDriverightMotor1 = new CANTalon(4);
        LiveWindow.addActuator("PIDDrive", "rightMotor1", pIDDriverightMotor1);
        
        pIDDriverightMotor2 = new CANTalon(5);
        LiveWindow.addActuator("PIDDrive", "rightMotor2", pIDDriverightMotor2);
        
        pIDDriverightMotor3 = new CANTalon(6);
        LiveWindow.addActuator("PIDDrive", "rightMotor3", pIDDriverightMotor3);
        
        pIDDriveprox1 = new AnalogInput(1);
        LiveWindow.addSensor("PIDDrive", "prox1", pIDDriveprox1);
