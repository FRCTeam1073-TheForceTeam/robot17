...
public class RobotMap {
    ...
    public static void init() {
        ...
        driveTrainQuadratureEncoder2 = new Encoder(2, 3, true, EncodingType.k4X);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        driveTrainQuadratureEncoder1.setMaxPeriod(1);
        driveTrainQuadratureEncoder1.setMinRate(10);
        driveTrainQuadratureEncoder1.setDistancePerPulse(5);
        driveTrainQuadratureEncoder1.setReverseDirection(false);
        driveTrainQuadratureEncoder1.setSamplesToAverage(7);
        
        driveTrainQuadratureEncoder2.setMaxPeriod(1);
        driveTrainQuadratureEncoder2.setMinRate(10);
        driveTrainQuadratureEncoder2.setDistancePerPulse(5);
        driveTrainQuadratureEncoder2.setReverseDirection(false);
        driveTrainQuadratureEncoder2.setSamplesToAverage(7);
    }
}
