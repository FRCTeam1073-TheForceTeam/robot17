...
public class DriveInches extends Command {
    ...
    private double currentLeft,currentRight,currentSpeed,destination,currentAvg,currentAng,currentMod;
    ...
    protected void execute() {
    	...
    	currentSpeed = -1*Math.abs((currentAvg/destination)-SPEED) + SPEED;
