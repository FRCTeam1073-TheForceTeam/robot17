...
public class BasicLaunchFuel extends Command {
	...
	protected void execute() {
    	...
    	SmartDashboard.putNumber("CurrentLauncherSpeed", RobotMap.launcherlauncherMotor1.getSpeed());
    	...
    	if(rightTriggerAxis >= 0.25) {
    		...
    		RobotMap.launcherlauncherMotor1.set(-1800);
    		
    		if (Math.abs(RobotMap.launcherlauncherMotor1.getSpeed()) >= 900){
    			
    			RobotMap.launcherconveyorMotor.set(-15);
    		}
    	} 
    	else {
    		...
    		RobotMap.launcherconveyorMotor.set(0);
    	}
