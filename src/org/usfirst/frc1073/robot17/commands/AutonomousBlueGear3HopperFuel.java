 ...
 *
 */
public class AutonomousBlueGear3HopperFuel extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public AutonomousBlueGear3HopperFuel() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
    	addSequential(new AutonomousBlueGear3());
		...
		case ROTATIONS:
			...
			break;
		case TIME:
			addSequential(new TimedDrive(10, 0));
			break;
		default:
			break;
		}
    	addSequential(new AutoTurn(.3, 20, "counterclockwise"));
    	...
    	addSequential(new moveWithPID(-40));
    	addSequential(new AutoTurn(.3, 20, "clockwise"));
