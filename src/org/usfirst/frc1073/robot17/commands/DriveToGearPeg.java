...
public class DriveToGearPeg extends Command {
    ...
    protected void execute() {
        ...
        double initialDriveMultiplier = 4;
        double initialChangeMultiplier = 1.5;
        double left = 0;
        double right = 0;
        double changeR = 0;
        double changeL = 0;
        ...
        if (xWidth > 24) {
        	driveSpeedMultiplier = 1.3;
        	changeR = 0.08;
        	changeL = 0.08;
        }
        else {
        	changeR = initialChangeMultiplier * 0.1;
        	changeL = initialChangeMultiplier * 0.1;
        	driveSpeedMultiplier = initialDriveMultiplier;
        }
