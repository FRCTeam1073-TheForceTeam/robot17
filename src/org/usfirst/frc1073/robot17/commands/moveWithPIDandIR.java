 ...
 *
 */
public class moveWithPIDandIR extends Command {
    ...
    double i = 0;
    public static double backProximity;
    
	public moveWithPIDandIR(double distInInches, double timeout, double irDistance) {
		distinInches = distInInches;
		backProximity = irDistance;
		timeOut = timeout;
