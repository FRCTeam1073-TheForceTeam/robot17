...
public class DriveToBoiler extends Command {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
        ...
        netTable = NetworkTable.getTable("VisionTableHG");
...
protected void execute() {
    ...
    SmartDashboard.putNumber("DriveToGearPeg xDeltaHG", xDeltaHG);
    xWidthHG =  netTable.getNumber("AverageWidthHG", 0);
    SmartDashboard.putNumber("DriveToGearPeg widthAvgHG", xWidthHG);
    ...
    */
    ...
    double viewAngleHG=75;
    double degreesPerPixelHG=viewAngleHG/imageWidthHG;
    double distanceHG = 2 * (1/(xWidthHG*degreesPerPixelHG)) * 57;
    /*
