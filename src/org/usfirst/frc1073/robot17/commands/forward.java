...
public class forward extends Command {
    ...
    protected void execute() {
    	speed = 1 - (Robot.driveTrain.getLeftDistanceInches() / (end / begin));
    	Robot.driveTrain.basicAutoDrive((-(startAngle - RobotMap.sensorsgyro.getAngle()/100))+speed, (startAngle - RobotMap.sensorsgyro.getAngle()/100)+speed);
    }
