...
public class DriveTrain extends Subsystem {
    ...
    **/
    ...
    {
    	return quadratureEncoder2.get();
    }
    
    public double getRawDistLeft()
    {
    	return quadratureEncoder1.getRaw();
    }
    
    public double getRawDistRight()
    {
    	return quadratureEncoder2.getRaw();
    }
    ...
    {
    	return quadratureEncoder2.getRate();
    }
    
    public boolean getDirectionLeft()
    {
    	return quadratureEncoder1.getDirection();
    }
    
    public boolean getDirectionRight()
    {
    	return quadratureEncoder2.getDirection();
    }
    
    public boolean isStoppedLeft()
    {
    	return quadratureEncoder1.getStopped();
    }
    
    public boolean isStoppedRight()
    {
    	return quadratureEncoder2.getStopped();
    }
