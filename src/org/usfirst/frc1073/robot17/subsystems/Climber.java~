...
public class Climber extends Subsystem {
    ...
    private final SpeedController climber2 = RobotMap.climberclimber2;
    private final SpeedController climber1 = RobotMap.climberclimber1;
