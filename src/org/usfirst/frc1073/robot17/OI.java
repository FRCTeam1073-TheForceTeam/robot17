...
public class OI {
    ...
    public OI() {
        ...
        joystickButton2 = new JoystickButton(driverRightStick, 1);
        joystickButton2.whenPressed(new forward(36));
        driverLeftStick = new Joystick(0);
        
        joystickButton1 = new JoystickButton(driverLeftStick, 1);
        joystickButton1.whenPressed(new turn(90));


        // SmartDashboard Buttons
        SmartDashboard.putData("DriveToGearPeg", new DriveToGearPeg());
